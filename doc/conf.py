# -*- coding: utf-8 -*-
#
# wla-dx documentation build configuration file, created by
...
latex_documents = [
  ('index', 'wla-dx.tex', u'wla-dx Documentation',
   u'vhelin', 'manual'),
]
...
man_pages = [
    ('index', 'wla-dx', u'wla-dx Documentation', [u'vhelin'], 7),
...
texinfo_documents = [
  ('index', 'wla-dx', u'wla-dx Documentation',
   u'vhelin', 'wla-dx', 'One line description of project.',
   'Miscellaneous'),
]
