...
release = '10.6a' # The full version, including alpha/beta/rc tags, |release|
language = None
#today = ''
#today_fmt = '%B %d, %Y'
exclude_patterns = []
...
for cpu in ['gb', '65c02', '65ce02', '6502', '65816', 'huc6280', 'spc700', 'z80', '6800', '6801', '6809', '8008', '8080', 'superfx']:
