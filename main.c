...
/*
  wla - part of wla dx gb-z80/z80/6502/65c02/6800/6801/6809/65816/huc6280/spc-700/8008/8080/SuperFX
...
char g_version_string[] = "$VER: wla-" WLA_NAME " 10.2a (19.3.2022)";
...
int main(int argc, char *argv[]) {
  ...
  if (g_output_format == OUTPUT_NONE || parse_flags_result == FAILED) {
    char title[] = "WLA " ARCH_STR " Macro Assembler v10.2a";
