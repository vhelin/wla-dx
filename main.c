...
char s_version_string[] = "$VER: wla-" WLA_NAME " 10.7a (28.12.2025)";
...
int main(int argc, char *argv[]) {
  ...
  if (g_output_format == OUTPUT_NONE || parse_flags_result == FAILED) {
    ...
    print_text(YES, "    use after -M\n");
    print_text(YES, "-MG Enable fake file handling, use after -M\n");
    print_text(YES, "-MD Request .o generation, use after -M\n");
