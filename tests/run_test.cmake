...
set(OUTPUT "${BINARY_DIR}/out.bin")
set(OUTPUT_SYM "${BINARY_DIR}/out.sym")
set(EXPECTED)
set(EXPECTED_SYM)
if(EXISTS "${SOURCE_DIR}/expected.bin")
    set(EXPECTED "${SOURCE_DIR}/expected.bin")
endif()
if(EXISTS "${SOURCE_DIR}/expected.sym")
    set(EXPECTED_SYM "${SOURCE_DIR}/expected.sym")
