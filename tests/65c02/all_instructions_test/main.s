    ...
    ; NOTE: 65c02 opcodes, as WLA DX understands them, can be found in /i65c02.c
    ; Please verify using external documentation (e.g. https://www.masswerk.at/6502/65c02_instruction_set.html)
    ...
    /////////////////////////////////////////////////////////////////////////////
    // TEST-01: basic smoke / opcode sanity / test every instruction (including 65c02 additions)
    /////////////////////////////////////////////////////////////////////////////
...
+
    ...
    trb C4_TRB                                  ; @BT 14 26
    tsb C4_TSB                                  ; @BT 04 27
    lda (C4_ZP_BASE)                            ; @BT B2 30
    sta (C4_ZP_BASE + 1)                        ; @BT 92 31
    ora (C4_ZP_BASE + 2)                        ; @BT 12 32
    and (C4_ZP_BASE + 3)                        ; @BT 32 33
    eor (C4_ZP_BASE + 4)                        ; @BT 52 34
    adc (C4_ZP_BASE + 5)                        ; @BT 72 35
    cmp (C4_ZP_BASE + 6)                        ; @BT D2 36
    sbc (C4_ZP_BASE + 7)                        ; @BT F2 37
...
+
    ...
    lda (T5C02_ZP_BASE)                             ; @BT B2 30
    sta (T5C02_ZP_BASE + 1)                         ; @BT 92 31
    ora (T5C02_ZP_BASE + 2)                         ; @BT 12 32
    and (T5C02_ZP_BASE + 3)                         ; @BT 32 33
    eor (T5C02_ZP_BASE + 4)                         ; @BT 52 34
    adc (T5C02_ZP_BASE + 5)                         ; @BT 72 35
    cmp (T5C02_ZP_BASE + 6)                         ; @BT D2 36
    sbc (T5C02_ZP_BASE + 7)                         ; @BT F2 37
