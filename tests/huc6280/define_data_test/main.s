...
label_19b:
        ...
        .db "12>"
        .dd %11111111111111111111111111111111, %10101010101010101010101010101010
        .dd %11111111111111111111111111111111 - 0 + 0, %10101010101010101010101010101010 - 0 + 0
        .dd %11111111111111111111111111111111 & %11111111000000001111111100000000
        .dd %11111111000000001111111100000000 | %00000000111111110000000011111111
        .db "<12"

        .db "13>"
        .dd $fffffff0 + $f, $a0a0a0a0 | $0b0b0b0b
        .dd 01234500h | 10000067h
        .db "<13"

        .db "14>"
        .dd V1, V1+1, V2, V2 | $00ff00ff
        .db "<14"

        .db "15>"
        .dd V3, V3+1, V4, V4 + $01020304
        .db "<15"
