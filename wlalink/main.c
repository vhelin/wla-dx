...
/*
  wlalink - part of wla dx gb-z80/z80/6502/65c02/6800/6801/6809/65816/huc6280/spc-700/8008/8080/superfx
...
char g_version_string[] = "$VER: wlalink 5.17a (29.3.2022)";
...
int main(int argc, char *argv[]) {
  ...
  if (i == FAILED) {
    char title[] = "WLALINK - WLA DX Macro Assembler Linker v5.17a";
